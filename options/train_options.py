...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        log_args.add_argument('--name', type=str, default="optimize",
                    help='hidden size (default: 256)')
        log_args.add_argument('--resume', type=bool, default=False,
                            help='hidden size (default: 256)')
        log_args.add_argument('--eval', type=bool, default=False,
                            help='hidden size (default: 256)')
        self.isTrain = True
        return parser
